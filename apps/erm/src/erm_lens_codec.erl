...
codec() ->
    ...
    case
        erlang:function_exported(json, encode, 1) andalso
            erlang:function_exported(json, decode, 1)
    of
        true ->
            json;
        false ->
            ...
            case
                erlang:function_exported(jsx, encode, 1) andalso
                    erlang:function_exported(jsx, decode, 2)
            of
                true -> jsx;
                false -> unavailable
            end
