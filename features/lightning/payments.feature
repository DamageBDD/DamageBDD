...
#  Scenario: I want to pay the lowest bidder
#publisher publishes bdd
#bidders bid
#publisher selects bidder
#damagebdd creates invoice
#when bidder completes task 
#then damagebdd releases payout 
