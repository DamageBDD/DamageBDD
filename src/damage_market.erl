        ...
        trails:trail(
            ...
            #{
                get =>
                    #{
                        tags => ?TRAILS_TAG,
                        description => "List all published testcases available for bidding.",
                        produces => ["text/html"]
                    },
                put =>
                    #{
                        tags => ?TRAILS_TAG,
                        description => "Publish a testcase for bidding.",
...
get_published(AeAccount) ->
    DamageAEPid = damage_ae:get_wallet_proc(AeAccount),
    gen_server:cast(DamageAEPid, {get_published, AeAccount}).
