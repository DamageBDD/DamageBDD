...
step(
    ...
    Pid = get_fail2ban_proc(Service, Context),
...
step(
    ...
    Pid = get_fail2ban_proc(Service, Context),
    JailName = list_to_atom("fail2ban_" ++ Service ++ "_jail"),
    Jail =
        maps:put(
            ban_time,
            list_to_integer(BanTime),
            maps:get(JailName, Context, DefaultJail)
        ),
...
step(
    ...
    [
        ...
        NumRequests,
        "failed SASL auth requests in the last",
        SinceSeconds,
        "seconds"
    ],
    _
